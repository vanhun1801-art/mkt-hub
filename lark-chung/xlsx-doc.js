...
/**
 * ============================================================================
 * ĐỌC FILE .XLSX — module dùng chung, không thêm một phụ thuộc nào
 * ============================================================================
 *
 *   const { docBang } = require('../lark-chung/xlsx-doc');
 *
 * Trước ở `lark-ads-manager/sync/xlsx.js` (đọc bản xuất Tourwell). Chuyển ra
 * đây khi app Social cần đọc bản xuất của TikTok LIVE Center — hai app đọc
 * cùng một định dạng thì phải dùng chung một bộ đọc. Chép đôi ra là sửa một
 * nơi, nơi kia sai lặng lẽ. Chỗ cũ giờ chỉ còn một dòng trỏ về đây.
 *
