...
tay). Mỗi base một khối: ô số kèm **▲▼ so kỳ trước** (kỳ trước cùng độ dài, nằm
liền trước) và bảng chi tiết. Base nào không đọc được thì nói rõ, **không hiện
số 0** — 0 và "không đọc được" là hai chuyện khác nhau.

Nút **Xuất báo cáo gửi Sếp** sinh một tệp HTML tự chứa, mở bằng trình duyệt nào
cũng đọc được, in thẳng ra PDF được (`@media print` đã chỉnh sẵn).
...
Có mốc theo tuần (hết ngày 7, 14, 21, 28, hôm nay) cho từng người và từng kênh.
...
**Nguồn số liệu** — hai đường vào. *Đổ tự động* gọi API các app con (Social đã
chạy; Ads/OTA/Công việc chưa nối) và hiện bảng **đang dùng → sẽ thành** trước khi
ghi, đánh dấu ô nào đổi và ô nào sẽ bị đổ về 0. *Tải file* cho nền tảng không có
API (YouTube · Douyin · Xiaohongshu · SEO · KOL): dán từ Excel hoặc chọn CSV, xem
thử khớp vào đâu rồi mới nạp. Số gốc không bao giờ bị ghi đè — luôn có nút về
số gốc.
...
tiêu, % đạt và tỷ trọng. Không còn ô nào phải tin suông. Điểm chấm tay sửa ngay
trên bảng, ô chưa chấm tô đỏ.
