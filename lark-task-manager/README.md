...
* Việc đã giải quyết **biến khỏi trang "Việc của tôi"**: nó thuộc làn
  **Đã nộp · chờ nghiệm thu**, mà làn đó chỉ hiện khi người dùng gõ vào ô tìm
  kiếm (`chiKhiTim`). Nộp xong là xong phần của nhân sự — không để trên màn hình
  nữa. Thẻ đếm "Đang trễ deadline" cũng không đếm nộ — con số ấy chỉ còn là việc
  trễ CHƯA nộp.
* Cần nộp lại file cuối thì gõ tên việc vào ô tìm kiếm: làn ấy hiện ra, nhân sự có
  nút "Nộp lại sản phẩm", quản lý có nút "Nghiệm thu · đóng việc". Quản lý còn
  thấy cả nhóm này ở Kanban, Bảng, và ở thẻ Quá hạn trên Marketing Hub
  (dòng "N việc trễ đã giải quyết").
